...
# Script to update .env file on the new EC2 instance
# Run this on your EC2 instance as the jobplatform user

echo "=== Updating .env file for backend ==="

# Prompt for PostgreSQL password
read -sp "Enter your PostgreSQL password for jobplatform user: " PG_PASSWORD
echo

# Backup existing .env if it exists
if [ -f /home/jobplatform/job-platform/backend/.env ]; then
    echo "Backing up existing .env file..."
    cp /home/jobplatform/job-platform/backend/.env /home/jobplatform/job-platform/backend/.env.backup.$(date +%Y%m%d_%H%M%S)
fi
...
# Database
DATABASE_URL=postgresql://jobplatform:PLACEHOLDER_PASSWORD@localhost/jobplatform_db
...
JWT_SECRET_KEY=cf1c2839a5f8e7d6b4c3a2f1e0d9c8b7a6f5e4d3c2b1a0f9e8d7c6b5a4f3e2d1
JWT_ALGORITHM=HS256
...
sed -i "s|PLACEHOLDER_PASSWORD|${PG_PASSWORD}|g" /home/jobplatform/job-platform/backend/.env
